...
(function() {
  Formbuilder.registerField('5LikertScale', {
    ...
    edit: "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-circle-o\"></span></span> Likert 5",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
...
(function() {
  Formbuilder.registerField('7LikertScale', {
    ...
    view: "<% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n  <div>\n    <label class='fb-option'>\n      <input type='radio' <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'checked' %> onclick=\"javascript: return false;\" />\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </label>\n  </div>\n<% } %>\n\n<% if (rf.get(Formbuilder.options.mappings.INCLUDE_OTHER)) { %>\n  <div class='other-option'>\n    <label class='fb-option'>\n      <input type='radio' />\n      Other\n    </label>\n\n    <input type='text' />\n  </div>\n<% } %>",
    edit: "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-circle-o\"></span></span> Likert 7",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
          label: "strongly disagree",
...
(function() {
  Formbuilder.registerField('TextField', {
    ...
    edit: "",
    addButton: "<span class=\"symbol\">&#182;</span> Hard Question",
    defaultAttributes: function(attrs) {
      return attrs;
    }
  });
...
'\'\n  placeholder=\'Add a longer description to this question\'></textarea>';
...
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'\'></button>' +
'<button id="submit_survey" class="fb-button" method="post">Submit</button>\n</div>';
