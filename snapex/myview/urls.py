...
urlpatterns = [
    ...
    url(r'^project/(\d+)/records$', views.myrecords, name='myview_project_records'),
   	url(r'^project/(\d+)/questionaires$', views.myquestionaires, name='myview_project_questionaires'),
   	url(r'^project/(\d+)/schedules$', views.myquestionaires, name='myview_project_schedules'),
    #url(r'^project_testess/(\d+)/w{30}$', views.mytestees, name='myview_project_testees'),
    url(r'^profile$', views.profile, name='myview_profile'),
    url(r'^survey$', views.mysurvey, name="myview_survey"),
